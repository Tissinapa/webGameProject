...
var PlayGame = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(PlayGame, [{
    ...
    value: function create() {
      ...
      this.physics.add.collider(this.dude, this.groundGroup); //Stars

      this.starsGroup = this.physics.add.group({});
      this.physics.add.collider(this.starsGroup, this.groundGroup);
      this.physics.add.overlap(this.dude, this.starsGroup, this.collectStar, null, this); //Redstars
      ...
      this.physics.add.collider(this.dude, this.masterBall, this.gameWon, null, this); //Scoreboard and health
      ...
      this.gameOverText = this.add.text(600, 400, "Game Over", {
        fontsize: "500px",
        fill: "#000000"
      });
      this.gameOverText.setOrigin(0.5);
      this.gameOverText.visible = false;
      this.dieSound = this.sound.add("die"); //game Won
...
},{"../assets/impact.WAV":"assets/impact.WAV","../assets/platform.png":"assets/platform.png","../assets/hearth.png":"assets/hearth.png","../assets/star.png":"assets/star.png","../assets/redStar.png":"assets/redStar.png","../assets/masterBall.png":"assets/masterBall.png","../assets/badGuy.png":"assets/badGuy.png","../assets/dude.png":"assets/dude.png"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
